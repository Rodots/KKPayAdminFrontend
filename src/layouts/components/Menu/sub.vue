...
const alwaysOpened = computed(() => rootMenu.alwaysOpenedsMenus.includes(props.uniqueKey.at(-1)!))
      ...
      nextTick(() => {
        requestAnimationFrame(() => {
          ...
          if (rootMenu.props.mode === 'vertical' || props.level !== 0) {
            ...
            menuLeft = (rootMenu.props.direction === 'ltr' ? left : document.documentElement.clientWidth - rect.right) + width + 4
            // 处理边界情况
            ...
            menuLeft = rootMenu.props.direction === 'ltr' ? left : document.documentElement.clientWidth - rect.right
          ...
          if (menuLeft + subMenuEl.offsetWidth > document.documentElement.clientWidth) {
            menuLeft = (rootMenu.props.direction === 'ltr' ? left : document.documentElement.clientWidth - rect.right) - width
          }
          // 设置样式
