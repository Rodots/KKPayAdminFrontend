...
<template>
  ...
  <FaModal v-model="dialog.visible" title="请输入一个方便记忆的名称" confirm-button-text="确认" cancel-button-text="取消" content-class="min-h-auto" :before-close="onBeforeClose" @confirm="onAdd" @cancel="dialog.visible = false">
