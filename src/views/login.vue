...
<template>
  ...
  <div class="login-box" :class="layoutAlign">
    <div class="login-banner">
      ...
      <FaCopyright v-if="settingsStore.mode === 'pc' && ['left', 'right'].includes(layoutAlign)" class="absolute bottom-0 w-full" />
    </div>
  ...
  <FaCopyright v-if="settingsStore.mode === 'mobile' || layoutAlign === 'center'" class="copyright" />
</template>
